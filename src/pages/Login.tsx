import { IonButton, IonCard, IonCardContent, IonCardHeader, IonCardSubtitle, IonCardTitle, IonContent, IonHeader, IonInput, IonItem, IonLabel, IonList, IonNavLink, IonNote, IonPage, IonSelect, IonSelectOption, IonText, IonTitle, IonToolbar } from '@ionic/react';
...
const Login: React.FC = () => {
  ...
  async function handleSubmit() {
    ...
    fetch('http://localhost:8080/Enchere/utilisateurs/login', {
        method: "POST",
