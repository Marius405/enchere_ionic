        ...
        <IonCardContent>
            <form action='authentification' className='ion-padding' id="form">
                <IonItem>
                    ...
                    <IonInput type="text" name="nom" id="nom" ></IonInput>
                ...
                <IonItem>
                    ...
                    <IonInput type="text" name="prenom" id="prenom" ></IonInput>
                ...
                <IonItem>
                    ...
                    <IonInput type="date" name="dtn" id="dtn" ></IonInput>
