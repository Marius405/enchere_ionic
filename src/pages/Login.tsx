import { IonButton, IonCard, IonCardContent, IonCardHeader, IonCardSubtitle, IonCardTitle, IonContent, IonHeader, IonIcon, IonInput, IonItem, IonLabel, IonList, IonNavLink, IonNote, IonPage, IonSelect, IonSelectOption, IonText, IonTitle, IonToolbar } from '@ionic/react';
...
const Login: React.FC = () => {
  const [email, setEmail] = useState('jeanne@gmail.com');
  const [mdp, setMdp] = useState('jeanne');
  ...
  async function handleSubmit() {
    ...
    fetch('https://encherews-production.up.railway.app/Enchere/utilisateurs/login', {
       ...
       .then(function(response) {
        ...
        else throw new Error('Une erreur s\'est produite! Réessayez');
      })
       .then((result) => {
  ...
  return (
    <IonPage>
      <IonContent fullscreen  className='contenu' >
        ...
        <IonCard>
        <IonCardHeader>
          <IonCardTitle class='head'>
            Login <IonIcon icon={lockClosedOutline} />
            </IonCardTitle>
        ...
        <IonCardContent>
          ...
          <IonNavLink className='navlink'><a href='/inscription' >Creer un compte</a></IonNavLink>
